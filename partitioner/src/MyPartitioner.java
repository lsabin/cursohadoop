...
public class MyPartitioner<K2, V2> extends Partitioner<Text, Text> implements
    Configurable {
  ...
  public int getPartition(Text key, Text value, int numReduceTasks) {
    /*
     * TODO implement
     * Change the return 0 statement below to return a string representation
     * of the month. Call months.get(value.toString()) and cast it to int.
     */
	  
	  int mes = months.get(value.toString());
